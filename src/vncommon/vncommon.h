...
void VNCommonLabel_initialize(std::shared_ptr<VNCommonLabel> label);
void VNCommonLabel_free(std::shared_ptr<VNCommonLabel> label);
void VNCommonLabel_print(std::shared_ptr<VNCommonLabel> label);
void VNCommonLabel_print(std::shared_ptr<VNCommonLabel> label, std::string myfile);
void VNCommonLabel_push_word(std::shared_ptr<VNCommonLabel> label, std::string text, std::string pron, std::string pos, std::string chunk, std::string tone);
void _VNCommonLabel_push_word(std::shared_ptr<VNCommonLabel> label, std::shared_ptr<VNCommonLabelChunk>, std::string text, std::string pron, std::string pos, std::string chunk, std::string tone);
...
void VNCommonLabel_make(VNCommonLabel *label);
